<?php 
	...
	if (!isset($action)) {
		...
		if ($action == 1) {
			...
			setcookie('news_image_1', 'news/_98509359_uscarproduction_getty.jpg', time() + 3600, '/');
			print '
    ...
    setcookie('news_image_2', 'news/_98453687_w0dskswv.jpg', time() + 3600, '/');
			print '
			...
			setcookie('news_image_3', 'news/_98501093_booking-template_4panel_976x549.jpg', time() + 3600, '/');
			# inicijalizacija kolačića
			print '
