...
<body>
	...
	if (!empty($_COOKIE['news_title_1']) || !empty($_COOKIE['news_title_2']) || !empty($_COOKIE['news_title_3'])) {
		print '<aside><h2 style="text-align:center">ZADNJE PREGLEDANO</h2>';
		
		if (!empty($_COOKIE['news_title_1'])) {
			print '
			<div>
				<img src="' . $_COOKIE['news_image_1'] . '" alt="' . $_COOKIE['news_title_1'] . '" style="width:100px; height:auto;">
				<p>' . $_COOKIE['news_title_1'] . '</p>
			</div>';
		}
		if (!empty($_COOKIE['news_title_2'])) {
			print '
			<div>
				<img src="' . $_COOKIE['news_image_2'] . '" alt="' . $_COOKIE['news_title_2'] . '" style="width:100px; height:auto;">
				<p>' . $_COOKIE['news_title_2'] . '</p>
			</div>';
		}
		if (!empty($_COOKIE['news_title_3'])) {
			print '
			<div>
				<img src="' . $_COOKIE['news_image_3'] . '" alt="' . $_COOKIE['news_title_3'] . '" style="width:100px; height:auto;">
				<p>' . $_COOKIE['news_title_3'] . '</p>
			</div>';
		}
